...
import { c, printTable, fmtDuration, toolSummary } from "./ui.js";
...
Commands:
  ...
  resume <issue#>           Resume a run, handing unacknowledged issue/PR comments to the agent
...
async function cmdStatus(opts) {
  ...
  printTable(rows, ["issue", "status", "att", "branch", "PR", "ended"]);
}
