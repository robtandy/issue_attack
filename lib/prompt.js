...
Steering — operator comments — is delivered to you between
...
export function taskPrompt({ issue, title, body, comments, base, branch, attempt }) {
...
export function statusCommentBody({ state, issue, attempt, elapsedMs, lastAction, extra }) {
  const lines = [
    STATUS_MARKER,
...
export function outcomeComment({ outcome, issue, prUrl, blockedBody, lastText, attempt, elapsedMs, logPath, worktree, retrying, conflicts }) {
